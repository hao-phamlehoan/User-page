...
function Body() {
  const [visibleBo, setVisibleBo] = React.useState(false);
  ...
  const [isActiveU, setActiveU] = React.useState(false);
  const [isActiveBo, setActiveBo] = React.useState(false);
  const [isActiveB, setActiveB] = React.useState(false);

  const [arr] = React.useState([]);
  const [Activearr] = React.useState([]);
            ...
            <div className="category">
              ...
              <li className="category-item">
                ...
                <li className="category-item">
                  ...
                  >
                    <i className="category-item-icon fa-solid fa-circle-user"></i>
                    <span className="category-item-name">Business List</span>
                ...
                <li className="category-item">
                  ...
                  >
                    <i className="category-item-icon fa-solid fa-circle-user"></i>
                    <span className="category-item-name">Booth Cost</span>
          ...
          <div className="col l-9 m-12 c-12">
            ...
            {visibleU && (
              <div className="approve">
                ...
                <div className="approve-description">
                  Trong trang này, admin có thể xem các doanh nghiệp và cho phép doanh nghiệp đăng ký gian hàng hay không.
                  Trang này chỉ có admin và các member được sử dụng.
                  Các thay đổi sẽ được áp dụng nếu được xem xét bởi ban điều hành. Hãy cẩn thận!
                </div>
            ...
            {visibleBo && (
              <div className="approve">
                <span className="approve-title">
                  Thay đổi giá các gian hàng
                </span>
                <div className="approve-description">
                  Trong trang này, admin có thể thay đổi giá cả gian hàng. 
                  Trang này chỉ có admin và các member được sử dụng.
                  Các thay đổi sẽ được áp dụng nếu được xem xét bởi ban điều hành. Hãy cẩn thận!
                </div>
